...
class PhotosTest < ApplicationSystemTestCase
  ...
  test "should create photo" do
    ...
    fill_in "Downvotes", with: @photo.downvotes
    fill_in "Event", with: @photo.event_id
    fill_in "Favorites count", with: @photo.favorites_count
    fill_in "Image url", with: @photo.image_url
    fill_in "Upvotes", with: @photo.upvotes
